  ...
  Worksheet.prototype.getCells = function() {
    ...
    return this.client.request({
      ...
      return function(data) {
        var cells, ref;
        cells = (ref = data.feed.entry) != null ? ref.map(function(i) {
          var _, col, colName, ref1, row, rowString;
          ref1 = i.title[0].match(/^([A-Z]+)(\d+)$/), _ = ref1[0], colName = ref1[1], rowString = ref1[2];
